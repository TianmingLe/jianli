...
import marketResearchSchool1Img from "@/data/xiangmu/市调校二项目展示1.webp";
import marketResearchSchool2ShowImg from "@/data/xiangmu/市调校二项目展示2.webp";
import marketResearchSchool3Img from "@/data/xiangmu/市调校二项目展示3.webp";
...
export const timeline = [
  {
    ...
    color: "volt",
    events: [
      { month: "09", title: "入学山西大学", desc: "能源与动力工程，担任军训负责人", icon: "GraduationCap" },
      { month: "10", title: "加入彩虹志愿者协会", desc: "开启校园组织生活", icon: "HeartHandshake" },
    ],
  },
  {
    year: "2024",
    ...
    events: [
      ...
      { month: "—", title: "全年自媒体", desc: "抖音 1.6K+ / 小红书 3000+ / B 站 800+", icon: "Megaphone" },
    ],
  },
  {
    year: "2025",
    color: "volt",
    events: [
      { month: "02", title: "市场调查大赛", desc: "《LLM 市场应用》校级二等奖", icon: "TrendingUp" },
      { month: "03", title: "4K 修复项目", desc: "《钢铁是怎样炼成的》4K 修复启动", image: baoer4kImg },
      { month: "06", title: "风电场运维实习", desc: "山西粤电盂县粤鑫风电场", icon: "Wind" },
      ...
      { month: "—", title: "全年自媒体", desc: "抖音 5K+ / 小红书 4000+ / B 站 9800+", icon: "Megaphone" },
    ],
  },
  {
    year: "2026",
    color: "mist",
    events: [
      { month: "03", title: "市场调查大赛", desc: "省级一等奖（康养五寨文旅研究）", icon: "TrendingUp" },
      { month: "03", title: "video-claw 开发", desc: "第一版视频抓取工具", icon: "Code2" },
      { month: "04", title: "智能眼镜 v0.1", desc: "Altezhong-yanjing MVP", image: smartGlassesImg },
      { month: "04", title: "video-tezhong 启动", desc: "第二版视频抓取工具", icon: "Rocket" },
      { month: "05", title: "web-niu / 眼镜 v2", desc: "Ambient Dream v2 + AItezhongyanjing-2", icon: "Glasses" },
...
export const awards = [
  ...
  },
  {
    ...
    gallery: [marketResearchSchool1Img, marketResearchSchool2ShowImg, marketResearchSchool3Img],
  },
  {
    id: "a04",
    year: "2025.06",
...
export const internships = [
  {
    ...
    company: "山西粤电能源有限公司",
    role: "盂县粤鑫风电场运维实习生",
    period: "2025.06（1天现场调研 + 2周校内分析）",
    keywords: ["风电场运维", "SCADA数据分析", "功率曲线诊断", "高压安全规范", "调研报告"],
    summary:
      "赴山西粤电能源有限公司盂县粤鑫风电场开展为期1天的实地调研与设备认知学习，并基于现场采集的运行数据与设备资料，在校内进行为期2周的深度数据分析与专题研究，最终形成《风电场运维安全与效率优化分析报告》，全面锻炼从现场感知到数据洞察的工程研究能力。",
    points: [
      "220kV升压站设备参观与安全学习：进入GIS组合电器、主变压器、SVG无功补偿装置等核心设备区，学习“五防”闭锁逻辑与标准安全交底流程，建立高压电气设备直观认知",
      "风机区域巡查与专项检测观摩：跟随运维班组实地查看塔筒、叶片、机舱等外部结构，了解日常巡检要点，观摩红外测温仪对母线、开关触头的测温操作",
      "SCADA系统数据整理与指标计算：使用Excel与Python清洗风电场历史运行数据，计算全场机组日发电量、可利用率和等效满发小时数等关键KPI",
      "功率曲线异常诊断分析：绘制风速-功率散点图并与标准功率曲线叠合对比，识别低风速段功率不足、高风速段功率波动等问题，初步推断叶片污染或偏航偏差等潜在原因",
      "高压安全与工程研究能力：深化“安全第一”的作业文化与“两票三制”规范意识，完成从现场观察到数据建模、从问题识别到方案提出的完整研究链路",
    ],
    highlights: [
      { text: "风速-功率散点图", color: "sky" },
      { text: "等效满发小时数", color: "amber" },
      { text: "220kV升压站", color: "amber" },
      { text: "标准安全交底", color: "rose" },
      { text: "工程研究能力", color: "volt" },
      { text: "深度数据分析", color: "volt" },
      { text: "“五防”闭锁", color: "rose" },
      { text: "“两票三制”", color: "rose" },
      { text: "SCADA系统", color: "sky" },
      { text: "红外测温仪", color: "sky" },
      { text: "实地调研", color: "volt" },
      { text: "设备认知", color: "volt" },
      { text: "专题研究", color: "volt" },
      { text: "偏航偏差", color: "amber" },
    ],
  },
  {
    id: "i02",
    ...
    role: "能源政策助理实习生",
    period: "2026.07",
    keywords: ["能源政策", "驻点调研", "项目审核", "容量电价机制", "三改联动"],
    summary:
      "赴大同市新荣区能源局进行实习，全程驻点机关并深入能源保供一线，深度参与政策文件研读、项目材料审核、风光电项目档案梳理及实地走访调研等核心工作，研读国家及省级能源政策文件百余份，完成从政策文本到基层执行的全链路认知构建，有效提升了能源行业分析与政策研判能力。",
    points: [
      "实习首日便进入全天候驻点状态，在局内食宿，从早晚例会、文件流转到值班调度逐一跟学，迅速融入了基层行政办公的规范与节奏。经手政策文件、项目申报材料及督办函件的登记、分发与归档，切身体会到信息传递的及时性与准确性对政策落地执行的关键影响。",
    ...
    highlights: [
      { text: "风光电项目档案梳理", color: "emerald" },
      { text: "走访辖区新能源场站", color: "emerald" },
      { text: "煤电提供可靠容量支撑", color: "amber" },
      { text: "可靠性支撑导向", color: "amber" },
      { text: "全链路认知构建", color: "violet" },
      { text: "能源结构转型", color: "violet" },
      { text: "“三改联动”", color: "violet" },
      { text: "能源保供一线", color: "volt" },
      { text: "政策文件研读", color: "volt" },
      { text: "政策落地执行", color: "amber" },
      { text: "容量电价机制", color: "amber" },
      { text: "煤电收益模式", color: "amber" },
      { text: "安全生产台账", color: "sky" },
      { text: "应急处理预案", color: "rose" },
      { text: "CCUS碳捕集", color: "emerald" },
      { text: "全天候驻点", color: "volt" },
      { text: "在局内食宿", color: "volt" },
      { text: "深入一线", color: "volt" },
      { text: "驻点机关", color: "volt" },
    ],
  },
  {
    id: "i03",
    ...
    highlights: [
      { text: "学习资源分享群", color: "emerald" },
      { text: "宣传活动策划", color: "emerald" },
      { text: "线上线下", color: "volt" },
      { text: "宣传展台", color: "volt" },
    ],
  },
];
