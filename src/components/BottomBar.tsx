...
export default function BottomBar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-shell items-center justify-around px-4">
        {tabs.map((tab) => {
          ...
          return (
            <Link
              key={tab.to}
              to={tab.to}
              className={`group relative flex flex-col items-center gap-1 px-4 py-2 font-mono text-[10px] uppercase tracking-widest transition-colors ${
                isActive
                  ? "text-mist-50"
            ...
            >
              ...
              {isActive && (
                <motion.span
                  ...
                  className="absolute -top-px left-1/2 h-0.5 w-6 -translate-x-1/2 bg-volt-400"
